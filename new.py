print('I have new added new file')

# echo "# Project_Python_Batch" >> README.md -> Here we are creating a new file 
# git init -> Making simple folder to local repository (that can track all the changes)
